...
export default function Header({ activeScreen, bestModel, onRetrain, isRetraining, onOpenLogin }) {
  ...
  return (
    <header className="flex flex-col md:flex-row justify-between items-start md:items-center px-6 lg:px-10 2xl:px-16 pt-8 2xl:pt-20 pb-4 2xl:pb-6 border-b border-[#3b3b3b] bg-[#333333] gap-4 font-roboto">
      <div className="flex items-center gap-3">
        <h2 className="text-lg md:text-2xl 2xl:text-4xl font-semibold text-white tracking-tight">{getTitle()}</h2>
      </div>
